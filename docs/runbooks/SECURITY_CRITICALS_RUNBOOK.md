...
- `promunch-email-agent/supabase/migrations/20260705100000_cron_jobs_canonical.sql` — canonical pg_cron topology (needs Vault secrets `service_role_key` + `cron_secret`; see docs/runbooks/CRON_TOPOLOGY.md).
