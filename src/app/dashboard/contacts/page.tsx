...
const statusColors: Record<string, { bg: string; color: string }> = {
  VIP: { bg: "rgba(124, 58, 237, 0.15)", color: "#a78bfa" },
          ...
          {filters.map((f) => (
            <button
              ...
              style={{
                padding: "8px 16px",
                borderRadius: "8px",
                border: activeFilter === f ? "1px solid #7c3aed" : "1px solid #27272a",
                backgroundColor: activeFilter === f ? "rgba(124, 58, 237, 0.15)" : "#18181b",
                color: activeFilter === f ? "#a78bfa" : "#a1a1aa",
                fontSize: "13px",
        ...
        <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
          ...
          {[1, 2, 3].map((p) => (
            <button
              ...
              style={{
                padding: "7px 12px",
                backgroundColor: p === 1 ? "rgba(124, 58, 237, 0.15)" : "#18181b",
                border: p === 1 ? "1px solid #7c3aed" : "1px solid #27272a",
                borderRadius: "8px",
                color: p === 1 ? "#a78bfa" : "#a1a1aa",
                cursor: "pointer",
                fontSize: "13px",
